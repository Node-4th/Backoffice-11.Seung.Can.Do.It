...
describe('TeamInfos Repository Unit Test', () => {
    ...
    test('findTeamInfos Method', async () => {
        const mockfindFirst = mockPrisma.TeamInfos.findFirst.mockResolvedValue(teamInfo);

        const findTeamInfos = await teamInfosRepository.findTeamInfos(teamInfo.teamInfoId);
    ...
    test('deleteTeamInfos Method', async () => {
        ...
        const deleteTeamInfos = await teamInfosRepository.deleteTeamInfos(teamInfo.teamInfoId);
